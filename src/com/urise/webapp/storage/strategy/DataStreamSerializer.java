...
public class DataStreamSerializer implements SerializerStrategy {
    ...
    public void doWrite(Resume resume, OutputStream os) throws IOException {
        try(DataOutputStream dos = new DataOutputStream(os)){
            ...
            writeSection(SectionType.PERSONAL, resume, dos);
            writeSection(SectionType.OBJECTIVE, resume, dos);
            writeSection(SectionType.ACHIEVEMENTS, resume, dos);
            writeSection(SectionType.QUALIFICATIONS, resume, dos);
            writeSection(SectionType.EXPERIENCE, resume, dos);
            writeSection(SectionType.EDUCATION, resume, dos);
        }
    }
